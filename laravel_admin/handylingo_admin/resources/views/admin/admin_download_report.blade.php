...
<head>
    ...
    <style>
        ...
        .header { margin-bottom: 30px; border-bottom: 2px solid #113882; padding-bottom: 10px; }
        .title { color: #113882; font-size: 28px; font-weight: bold; margin: 0; }
        .subtitle { font-size: 18px; color: #64748b; margin: 5px 0; }
        
        /* Table used for layout instead of Grid */
        .summary-table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        .card { background: #ffffff; border: 1px solid #e2e8f0; padding: 20px; text-align: center; width: 45%; }
        .card-label { font-size: 12px; text-transform: uppercase; color: #94a3b8; font-weight: bold; }
        .card-value { font-size: 32px; font-weight: bold; color: #1e293b; margin: 10px 0; }
        
        .chart-section { margin-top: 40px; text-align: center; }
        .chart-title { font-size: 20px; font-weight: bold; margin-bottom: 15px; text-align: left; }
        .chart-img { width: 100%; max-width: 500px; border: 1px solid #eee; }
        .no-data { padding: 50px; text-align: center; border: 2px dashed #cbd5e1; color: #94a3b8; }
    </style>
</head>
<body>
    ...
    <div class="chart-section">
        ...
        @if($ratingsChartImageUrl)
            <img src="{{ $ratingsChartImageUrl }}" class="chart-img">
        @else
            <div class="no-data">
